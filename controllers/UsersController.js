...
exports.updateUser = async (req, res) => {
    ...
    try{
        ...
        if(findByNameOrMail && (findUser.email !== findByNameOrMail.email) && (findUser.email !== req.body.email)) {
            errors.errors.email = "Email already taken";
        }
        if(findByNameOrMail && (findUser.username !== findByNameOrMail.username) && (findUser.username !== req.body.username)) {
