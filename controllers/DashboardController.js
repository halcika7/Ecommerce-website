...
exports.dashboard = async (req, res) => {
    try {
        ...
        const numberOfActiveCoupons = await CouponModel.find({  exparationDate: { $gt: new Date() } }).countDocuments();
        ...
        const bestSellingProducts = await ProductModel.aggregate([
         ...
         return res.json({ numberOfProducts, numberOfOrders, numberOfActiveCoupons, numberOfSoldProducts, latestTransactions, bestSellingProducts, successMessage: 'Success Message' });
