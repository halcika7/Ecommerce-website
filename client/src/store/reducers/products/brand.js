...
const reducer = (state = initialState, action) => {
  const actions = {
    [actionTypes.BRAND_START]: updateObject(state, {
      ...initialState,
      loading: true
    }),
    [actionTypes.CLEAR_BRAND_STATE]: updateObject(state, {
      ...initialState
    }),
    [actionTypes.BRAND_FAILED]: updateObject(state, {
    ...
    [actionTypes.BRAND_SUCCESS]: updateObject(state, {
