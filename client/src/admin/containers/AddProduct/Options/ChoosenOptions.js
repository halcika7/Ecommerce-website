			...
			{options.map((option, index) => (
				<div key={index}>
					<label
						...
						data-target={'#' + index}
						data-tooltip={`Click to show ${option.color ? option.color.toLowerCase() : (option.display ? option.display : option.console)} options`}>
                            ...
                            {(subCatName === 'Projection Screens') && (
                                <React.Fragment>
                                    Screen Size: <span className="color-name">{option.display}</span>
                                </React.Fragment>
                            )}
                            {subCatName === 'Games' && (
                                <React.Fragment>
						...
						{option.options.map((opt, i) => (
							<div className="form-group row mb-4" key={i}>
                                ...
                                {subCatName === 'Desktop Computers' && (
                                    <React.Fragment>
                                        <div className="col-md-2 mb-3"><ToggleSwitchButton name="Mouse" value={opt.withMouse} disabled={true} /></div>
                                        <div className="col-md-2 mb-3"><ToggleSwitchButton name="Keyboard" value={opt.withKeyboard} disabled={true} /></div>
                                        <div className="col-md-2 mb-3"><ToggleSwitchButton name="Display" value={opt.withDisplay} disabled={true} /></div>
                                    </React.Fragment>
                                )}
                                {subCatName === 'Laptops' && (
                                    <LoginRegisterInputs
                                ...
                                {(subCatName === 'Monitors' || subCatName === 'Televisions') && (
                                    <React.Fragment>
                                        ...
                                        <LoginRegisterInputs
                                            ...
                                            disabled={true}
                                        />
                                        <div className="col-sm-3 mb-3"><ToggleSwitchButton name="Smart" value={opt.smart} disabled={true} /></div>
                                        <div className="col-sm-3 mb-3"><ToggleSwitchButton name="3D" value={opt.threeD} disabled={true} /></div>
                                    </React.Fragment>
                                )}
							</div>
						))}
