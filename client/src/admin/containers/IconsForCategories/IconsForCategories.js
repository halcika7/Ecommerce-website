                ...
                <React.Fragment>
                    <div className="Card card text-white">
                        <div className="card-header">
                            ...
                            {props.viewicon && <h4 className="text-white"><img src={iconName} alt={iconName} /> Icon</h4>}
                        ...
                        <div className="card-body">
                            <div className="col-12">
                                <form>
                                    ...
                                    {(props.addicon || props.editicon) && <button className="btn btn-sm mt-20" onClick={onSubmit}>{props.addicon ? 'Add New Icon': 'Update Icon'}</button>}
                                </form>
                            </div>
                        </div>
                    </div>
