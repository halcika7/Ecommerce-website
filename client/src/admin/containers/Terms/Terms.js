...
const Terms = props => {
	...
	useEffect(() => {
		(props.view || props.edit) && props.getTerm(new URLSearchParams(props.location.search).get('id'));
	}, [])
    ...
    const onFormSubmit = e => {
		...
		props.edit && props.updateTerm({ term: values.term, text: values.text }, id);
		setValues({ term: '', text: '' });
		setErrors({ term: '', text: '' });
    }
	...
	return (
		<div className={'AdminProfile row'}>
            ...
            {props.terms.failedMessage && <ResponseMessage message={props.terms.failedMessage} ClassName="Danger" />}
            {props.terms.successMessage && <ResponseMessage message={props.terms.successMessage} />}
								...
								<div className="col-12">
									<form onSubmit={onFormSubmit}>
										...
										<textarea
											...
											className={(errors.term || props.view) ? 'invalid col-12' : 'col-12 mb-4'}
											disabled={props.view ? true : false}
										/>
                                        {errors.term && <div className='invalid-feedback mb-4'>{errors.term}</div>}
										...
										<textarea
											...
											className={(errors.text || props.view) ? 'invalid col-12' : 'col-12 mb-4'}
											disabled={props.view ? true : false}
										/>
