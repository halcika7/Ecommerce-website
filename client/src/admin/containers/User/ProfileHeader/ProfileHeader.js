            ...
            <div className={classes.userInfo}>
                <div className="row mb-30">
                    <div className="col-lg-6 d-flex align-items-center flex-wrap">
                        ...
                        <div className={classes.userDetail}><h2 className="name">{props.user.name}</h2></div>
                    </div>
                </div>
                <div className="row d-none d-md-flex text-white">
                    ...
                    <div className="col-md-3">
                        <div className="ttl-info text-left">
                            <h6><i className="fa fa-calendar"></i>&nbsp;&nbsp;&nbsp;Company</h6>
                            <span>HalcStore</span>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="ttl-info text-left">
                            <h6><i className="fa fa-calendar"></i>&nbsp;&nbsp;&nbsp;Employed</h6>
