		...
		<React.Fragment>
			<div className="row">
				<Widget
					...
					value={props.dashboard.numberOfProducts}
				/>
				<Widget
					label="Total Active Coupons"
					value={props.dashboard.numberOfActiveCoupons}
					icon="fas fa-tag"
				/>
				<Widget
					label="Total Number of Orders"
					value={props.dashboard.numberOfOrders}
					icon="fas fa-folder-open"
				/>
				<Widget
					label="Sold Products"
					value={props.dashboard.numberOfSoldProducts}
