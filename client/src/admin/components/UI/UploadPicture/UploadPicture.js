    ...
    return (
        <React.Fragment>
            <label className={classes.btn2}>
                Upload Picture
                <input className={classes.input} type='file' onChange={readURL} name={props.name}/>
            </label>
            <img id="updloadPicture" src={url.imgSrc} alt="you" width="180" height="180" className="d-block"/>
        </React.Fragment>
