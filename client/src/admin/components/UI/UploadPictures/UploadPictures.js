...
const UploadPictures = props => {
    const readURL = (e) => {
        ...
        const output = document.querySelector('.UploadPictures_imagesPerview__9Aw3Z');
    ...
    return (
        <React.Fragment>
            <label className={classes.btn2}>
                Upload Pictures
                <input className={classes.input} type='file' onChange={readURL} multiple/>
            </label>
            <div className={classes.imagesPerview} ></div>
