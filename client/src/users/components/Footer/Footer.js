...
const state = {
    categories: [
        'Desktops','Laptops & Notebooks','Components','Tablets','Software',"Phones & PDA's",'Cameras'
    ],
    customerCare: [
        'Contact Us','Storelocator','Delivery Information','Privacy Policy','Terms & Conditions'
    ]
}
        ...
        <footer className={classes.footer}>
            <div className={classes.container + " container"}>
                <div className="row justify-content-md-center">
                    <div className="col-10 col-sm-6 col-lg-3">
                        ...
                        <div className={classes.contactFooter}>
                            ...
                            <div className={classes.infoFooter}>
                                <p className={classes.questions}>Got Questions ? Call us 24/7!</p>
                    ...
                    <div className="col-10 col-sm-6 col-lg-3">
                        <h5 className={classes.h5 + " " + classes.signup}>Sign Up To New Letter</h5>
                        <p className={classes.signup}>
                            Make sure that you never miss our interesting news by joining our newsletter program
                        </p>
                        <div className={classes.inputGroup}>
                            <input type="email" className={classes.formControl} placeholder="Your Email" />
                        </div>
            ...
            <div className={classes.containerFluid + " container-fluid"}>
                <div className={classes.container + " container"}>
                    <div className={classes.row + " row"}>
                        ...
                        <a className="float-right back-to-top" href="/" onClick={scrolltotop}>
