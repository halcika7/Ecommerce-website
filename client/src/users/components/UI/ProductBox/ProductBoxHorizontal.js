                    ...
                    <div className="product-full-width">
                        ...
                        <div className="product-full-width-details">
                            <div className="product-full-width-description">
                                ...
                                <p className="details d-none d-lg-flex">{product.smalldescription}</p>
                                <div className={"d-none d-lg-flex product rating rating-"+product.rating.averageRating}>
                            ...
                            <div className="product-full-width-price">
                                ...
                                <Link to={`/product?id=${product._id}`} className="add-to-cart" role="button">View Product</Link>
                            </div>
                        </div>
                    </div>
                </div>
