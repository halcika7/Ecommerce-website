        ...
        <div className={c.col12 + ' ' + c.colLg4 + ' col-12 col-lg-4'}>
          <div className={c.jumbotroneSearch}>
            <div>
              ...
              <SearchResults
                searchResults={props.searchedProducts}
          ...
          <div className={c.jumbotroneLinks}>
            <div className={c.row + ' row'}>
              <div className="wishlist">
                <a href="/" aria-label="jfoia" target="_self" rel="noopener">
...
export default React.memo(
  connect(mapStateToProps, dispatchMapToProps)(MiddleNavigation)
);
