...
const TopNavigation = props => {
    ...
    useEffect(() => { setUser({...props.userState}); setIsAuthenticated(props.isAuthenticated); }, [props.userState]);
    useEffect(() => { setIsAuthenticated(props.isAuthenticated); }, [props.isAuthenticated]);
    const [linksLeft] = useState([ {name: 'Support', link: '/support'}, {name: 'Store Locator', link: '/storelocator'}, {name: 'Track Your Order', link: '/kpkop'} ]);
