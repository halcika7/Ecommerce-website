...
const RegisterForm = props => {
    ...
    const [inputs] = useState([
        ...
        {name: 'username',placeholder: 'Username',label: 'Username',type: 'text'},
    ...
    return (
        <React.Fragment>
            {!register.errors ? <Spinner/> :
            <React.Fragment>
                {register.message ? <ResponseMessage message={register.message} /> : null}
                {register.failedMessage ? <ResponseMessage ClassName="Danger" message={register.failedMessage} /> : null}
