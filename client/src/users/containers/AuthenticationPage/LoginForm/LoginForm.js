...
const LoginForm = props => {
    ...
    const [login, setLogin] = useState({errors:{usrenameEmail:'', password:''},usernameEmail: '',password: '', rememberMe: false, successMessage: false, failedMessage: false});

    const [resetPassword, setResetPassword] = useState({email: '',errors: {email: ''},success: false});
        ...
        <React.Fragment>
            ...
            <form onSubmit={onLoginFormSubmit}>
                ...
                <div className={classes.formBox + ' ' + classes.Checkbox}>
                    <input type="checkbox" name="rememberMe" checked={login.rememberMe ? login.rememberMe : false} onChange={() => {}}/>
                    <label onClick={changeRememberMe}>Remember me</label>
                </div>
