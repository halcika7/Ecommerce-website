...
const StripeComponent = props => {
	const [cardElementErrors, setCardElementsErrors] = useState({
		cardNumber: '',
		cardExpiry: '',
		cardCvc: ''
	});
	...
	return (
		<div className={c.container + ' container mb-3 ' + c.checkout}>
			{props.failedMessage && (
				<ResponseMessages ClassName="Danger" message={props.failedMessage} />
			)}
...
const mapDispatchToProps = dispatch => ({
	payment: (token, userData, callBack) =>
