			...
			<div className="col-md-6">
				...
				<div className="review-score">
					<div className="scores">
						<p className="number">
							{productRatings.avg ? productRatings.avg : 0}
						</p>
						<p className="text">Average Score</p>
					</div>
				</div>
				<ul>
					{productRatings.ratingsWithPercentages &&
						productRatings.ratingsWithPercentages.map(rating => (
			...
			<div className="col-md-6">
				...
				<div className="user-rating">
					...
					<div className="stars-rating">
						<span
							className={rating > 4 ? 'star star-color' : 'star'}
							data-value="5"
							onClick={starOnClick}>
							<i className="fa fa-star" />
						</span>
						<span
							className={rating > 3 ? 'star star-color' : 'star'}
							data-value="4"
							onClick={starOnClick}>
							<i className="fa fa-star" />
						</span>
						<span
							className={rating > 2 ? 'star star-color' : 'star'}
							data-value="3"
							onClick={starOnClick}>
							<i className="fa fa-star" />
						</span>
						<span
							className={rating > 1 ? 'star star-color' : 'star'}
							data-value="2"
							onClick={starOnClick}>
							<i className="fa fa-star" />
						</span>
						<span
							className={rating > 0 ? 'star star-color' : 'star'}
							data-value="1"
							onClick={starOnClick}>
							<i className="fa fa-star" />
						</span>
				...
				<div className="user-comment">
					<div className="wrapper-content-editabel">
						<textarea
							...
							value={reviewText}
						/>
						<div className="navbar-content-editable" />
					</div>
					{props.userId && (
						<button
							className="btn btn-default add-comment"
							type="button"
							onClick={addReview}>
							Add Review
						</button>
