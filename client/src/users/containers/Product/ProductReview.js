...
const ProductReview = ({ inStock, numberInStock, rating }) => {
    return (
        <div className="review">
            <div className="stars">
                <div className={rating.averageRating === 0 ? 'star' : 'star-'+rating.averageRating}>
                ...
                <p>{rating.numberOfReviews === 1 ? (rating.numberOfReviews)+'review' : (rating.numberOfReviews)+'reviews'}</p>
            </div>
