	...
	return (
		<div
			...
			<div className="col-12">
				...
				<button className="btn btn-info" onClick={onFormSubmit}>
					Save Changes
				</button>
			</div>
			<br />
			...
			<div className="col-12">
				...
				<button className="btn btn-info" onClick={updatePassword}>
					Save Password
				</button>
			</div>
			<br />
			...
			<div className="col-12">
				...
				{showButton && (
					<button className="btn btn-info" onClick={submitUpdateProfilePicture}>
