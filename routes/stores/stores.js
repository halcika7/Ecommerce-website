...
// Stores Routes
router.post('/addstore', multerStorePicture.single('picture') , StoresController.addStore);
router.patch('/updatestore', multerStorePicture.single('picture') , StoresController.updateStore);
